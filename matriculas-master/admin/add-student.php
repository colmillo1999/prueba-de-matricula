	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact"  value="<?= isset($pcontact)? $pcontact: '' ; ?>" placeholder="+51........." required="">
	  	</div>
	  	<div class="form-group">
		    ...
		    <select name="class" class="form-control" id="class" required="">
		    	...
		    	<option value="A. Emp" >A. Emp</option>
		    	<option value="Mecanica A" >Mecanica A</option>
		    	<option value="Electricidad I" >Electricidad I</option>
		    </select>
	  	</div>
	  	<div class="form-group">
