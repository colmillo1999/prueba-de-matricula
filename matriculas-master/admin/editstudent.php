		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <select name="class" class="form-control" id="class" required="" value="">
		    	...
		    	<option value="A. R.c" <?= $row['class']=='A. R.c'? 'selected':'' ?>>A. R.c</option>
		    	<option value="A. Emp" <?= $row['class']=='A. Emp'? 'selected':'' ?>>A. Emp</option>
		    	<option value="Mecanica A" <?= $row['class']=='Mecanica A'? 'selected':'' ?>>Mecanica A</option>
		    	<option value="Electricidad I" <?= $row['class']=='Electricidad I'? 'selected':'' ?>>Electricidad I</option>
		    </select>
	  	</div>
	  	<div class="form-group">
